...
const HomePage = () => {
  ...
  const truncateAbstract = (text, maxLength = 100) => {
    if (!text) return "";
      ...
      <div className="hero-section">
        <div className="hero-content">
          <div className="hero-text">
            <h1>
                 Revue d'Information<br></br><span className="highlight">Scientifique et Technique</span>
            </h1>
            <p className="hero-subtitle">
            RIST est une revue semestrielle éditée par le CERIST publiant tout travail de recherche se rapportant aux domaines des science de l'information,
             de l'informatique documentaire, de la documentation, de l'archivistique et des nouvelles technologies de l'information
            </p>
          </div>
            ...
            <div className="articles-grid" id="articles-scroll-recent">
              {recentArticles.map((article) => (
                ...
                >
                  ...
                  <div className="article-content">
                    <div className="article-type">{article.type || 'Research Paper'}</div>
                    <h3>{article.title}</h3>
                    <p className="article-meta">
                      <span className="meta-label">By:</span> {article.author}
                    </p>
                    ...
                    <div className="article-footer">
                      <span className="article-date">
                        <FontAwesomeIcon icon={faCalendarAlt} /> {new Date(article.publication_date).toLocaleDateString()}
                      </span>
                      <span className="article-views">
                        <FontAwesomeIcon icon={faEye} /> {Math.floor(Math.random() * 500) + 50}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="article-content">
                    ...
                    <div className="article-footer">
                      ...
                      <span className="article-views">
                        <FontAwesomeIcon icon={faEye} /> {article.views.toLocaleString()}
                      </span>
                    </div>
                  </div>
                </div>
